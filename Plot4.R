...
plot(df4$Combined_time, df4$Voltage, ylab = 'Voltage', xlab = 'datetime', type = 'l')
...
legend('topright', col = c('black', 'red', 'blue'), legend = c('Sub_metering_1', 'Sub_metering_2', 'Sub_metering_3'), lwd   = 1, cex = 0.7, bty = 'n' )
plot(df4$Combined_time , df4$Global_reactive_power, type = 'l', ylab = 'Global_reactive_power', xlab = 'datetime')
dev.off()